...
public class BuscarNumCod extends StoredProcedure{
	ArrayList<BeanServicio> numcod = new ArrayList<BeanServicio>();
	String sql = Constantes.PAQUETE_OPERACIONSERVICIO+Constantes.FLRT_BUSCAR_NUMCOD;
	
	public BuscarNumCod(DataSource ds){
		setDataSource(ds);
		setSql(sql);
